...
const Services = () => {
  return (
    <div className=" pt-[100px]  pb-10 ">
      <Container>
        <div className="p-10 bg-green-100 rounded-md border-green-600 border">
            ...
            <div className="border border-green-500 rounded-md bg-green-100 p-5 Services-1 ">
              ...
              <div className="absolute">
                ...
                <p className="text-[14px] text-white">
                  Teaching Islamic fundamentals of the Noble Qur'an and Tajweed
                  in person and otherwise. Attendance (online) for adult
                  children.
                </p>
              </div>
            </div>
